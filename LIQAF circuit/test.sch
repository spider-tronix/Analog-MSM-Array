...
.param LP1=0.15
"}
C {devices/code_shown.sym} 810 -220 0 0 {name=SPICE only_toplevel=false value=".dc V1 0 1.8 0.01
.control
run
plot v(Vout) v(Vin)-v(Vout1)-0.645 v(Vin)-v(Vout)-0.645 v(Vin)-v(Vout)+0.645 v(Vin)-v(Vout2)+0.645
.endc
.save all"}
...
C {devices/code_shown.sym} 770 -660 0 0 {name=PARAMETERS only_toplevel=false value="
.param LP1=0.15
.param WP1=25
.param LN1=0.15
.param WN1=12.5
